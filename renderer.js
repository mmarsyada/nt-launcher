...
const configFile = require('os').homedir() + '/newtempest_launcher.json';
var config = {folder: 'C:\\SWGNewTempest'};
...
websiteBtn.addEventListener('click', event => shell.openExternal("http://swgemu.newtempest.com/"));
discordBtn.addEventListener('click', event => shell.openExternal("https://discord.gg/bAWpSXjpZF"));
